...
source $BLACKHOLE/miniforge3/bin/activate
...
hf download prometheus-eval/prometheus-7b-v2.0 --local-dir ./models/Prometheus-2-7B

# Patronus-Lynx Model
echo "Downloading Patronus-Lynx-8B-v1.1..."
hf download PatronusAI/Llama-3-Patronus-Lynx-8B-Instruct-v1.1 --local-dir ./models/Patronus-Lynx-8B
